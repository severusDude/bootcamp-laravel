<footer
    ...
    <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
        &copy; 2019-2022 <a href="#" class="hover:underline"
            target="_blank">{{ config('app.name', 'Beritaks') }}.com</a>. All
        rights reserved.
    </p>
    <div class="flex justify-center items-center space-x-1">
        <a href="https:/github.com/severusDude/bootcamp-laravel" data-tooltip-target="tooltip-github"
